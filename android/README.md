...
- Bundled on-device ML Kit OCR, image labels, and five-landmark face detection. OCR evidence retains normalized block regions.
...
- Verified SigLIP2 retrieval and OpenCV SFace identity model packs. SFace runs through ONNX Runtime, produces normalized 128-dimensional embeddings, stores them in an app-private FP16 index, and remains opt-in for people indexing.
