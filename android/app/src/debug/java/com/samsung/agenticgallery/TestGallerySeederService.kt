...
class TestGallerySeederService : Service() {
    ...
    private fun notification(message: String, progress: Int, total: Int): Notification =
        NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("AgenticGallery test gallery")
    ...
    companion object {
        const val ACTION_SEED = "com.samsung.agenticgallery.test.SEED_GALLERY_FOREGROUND"
        const val ACTION_CLEANUP = "com.samsung.agenticgallery.test.CLEANUP_GALLERY_FOREGROUND"
        const val ACTION_IMPORT = "com.samsung.agenticgallery.test.IMPORT_SEEDED_FOREGROUND"
        const val ACTION_INDEX = "com.samsung.agenticgallery.test.INDEX_SEEDED_FOREGROUND"
