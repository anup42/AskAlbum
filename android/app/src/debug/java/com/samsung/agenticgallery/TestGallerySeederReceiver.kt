...
class TestGallerySeederReceiver : BroadcastReceiver() {
    ...
    private fun reportIndexCoverage(context: Context, runId: String) {
        ...
        val application = context.applicationContext as AgenticGalleryApplication
    ...
    companion object {
        const val ACTION_SEED = "com.samsung.agenticgallery.test.SEED_GALLERY"
        const val ACTION_CLEANUP = "com.samsung.agenticgallery.test.CLEANUP_GALLERY"
        const val ACTION_IMPORT = "com.samsung.agenticgallery.test.IMPORT_SEEDED"
        const val ACTION_REMOVE_IMPORTED = "com.samsung.agenticgallery.test.REMOVE_IMPORTED"
        const val ACTION_PREPARE_INTERRUPTION = "com.samsung.agenticgallery.test.PREPARE_INDEX_INTERRUPTION"
        const val ACTION_VERIFY_RECOVERY = "com.samsung.agenticgallery.test.VERIFY_INDEX_RECOVERY"
        const val ACTION_REPORT_INDEX = "com.samsung.agenticgallery.test.REPORT_INDEX_COVERAGE"
        const val ACTION_RESUME_INDEX = "com.samsung.agenticgallery.test.RESUME_INDEXING"
