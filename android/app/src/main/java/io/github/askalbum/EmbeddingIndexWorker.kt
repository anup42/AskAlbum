    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        try {
            ...
            while (
                ...
                if (!batch.stopped) repository.renewIndexingLeases(IndexingPipeline.EMBEDDINGS, ownerId)
            ...
            withContext(NonCancellable) {
                repository.releaseIndexingLeases(IndexingPipeline.EMBEDDINGS, ownerId)
            }
        }
    }
