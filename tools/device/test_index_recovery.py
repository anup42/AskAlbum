...
def main() -> None:
    ...
    broadcast(serial, args.package, "com.askphotos.android.test.PREPARE_INDEX_INTERRUPTION", run_id)
    ...
    broadcast(serial, args.package, "com.askphotos.android.test.VERIFY_INDEX_RECOVERY", run_id)
